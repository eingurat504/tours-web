...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('bookings.show' , $booking->id) }}">{{ $booking->traveller_name }}</a></li>
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">Update Booking</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="traveller_name" id="traveller_name" required
                                   ...
                                   value="{{ old('traveller_name' , $booking->traveller_name ) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="traveller_phone_no" id="traveller_phone_no" required
                                   ...
                                   value="{{ old('traveller_phone_no', $booking->traveller_phone_no) }}"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="traveller_flight_no" id="traveller_flight_no" required
                                   ...
                                   value="{{ old('traveller_flight_no', $booking->traveller_flight_no ) }}"/>
                            @error('traveller_flight_no')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="panel">
                    ...
                    <div class="form-group">
                            ...
                            <input type="date" name="from_date" id="from_date" required
                                   ...
                                   value="{{ old('from_date', $booking->from_date) }}" data-date-format="YYYY-MM-DD"/>
                            @error('from_date')
                            <span class="invalid-feedback" role="alert">{{ $message }}</span>
                            @enderror
                        </div>
